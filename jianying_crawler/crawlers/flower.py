...
class FlowerCrawler(BaseCrawler):
    crawler_name = "flower"
    panel = "flower"
    page_size = 50
    ...
    def crawl_category(self, category_id: str, category_key: str) -> None:
        ...
        while True:
            ...
            raw_name = f"flower_{category_id}_page_{page_index}.json"
            data, raw_path = self.parse_response_or_save_raw(response, raw_name)
    ...
    def fetch_detail(
        ...
        raw_name = f"flower_detail_{resource_id}.json"
