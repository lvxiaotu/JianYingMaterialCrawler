...
class FilterCrawler(BaseCrawler):
    crawler_name = "filter"
    panel = "filter"
    category_id = "11568"
    ...
    def crawl_category(self, category_id: str, category_key: str) -> None:
        ...
        while True:
            ...
            raw_name = f"filter_{category_id}_page_{page_index}.json"
    ...
    def fetch_detail(
        ...
        raw_name = f"filter_detail_{resource_id}.json"
    ...
    def add_downloads(self, resource_id: str, common: dict, item: dict) -> None:
        ...
        filter_payload = item.get("filter") or {}
        if isinstance(filter_payload, dict) and filter_payload.get("original_image"):
            self.repo.add_download(resource_id, str(filter_payload["original_image"]), "filter_original_image")
