...
class TaskEffectCrawler(BaseCrawler):
    ...
    def crawl_category(self, category_id: str, category_key: str) -> None:
        ...
        while True:
            ...
            raw_name = f"task_effect_{category_id}_page_{page_index}.json"
    ...
    def fetch_detail(
        ...
        raw_name = f"task_effect_detail_{resource_id}.json"
        ...
        for item in iter_effect_items(data):
            ...
            self.repo.upsert_item(
                ...
                panel=self.panel,
                category_id=category_id,
                source_kind="task_effect_detail",
